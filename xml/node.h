...
enum NodeReturnCodes ElementNode_setAttribute(struct Node *self, char *name, char *value);
struct KeyValue *ElementNode_getAttribute(struct Node *self, char *name);
